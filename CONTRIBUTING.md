...
```bash
$ git clone git@github.com:username/grunt-amd-build.git
```

This will clone your fork to your current path in a directory named `grunt-amd-build`.
...
```bash
$ cd grunt-amd-build
$ git remote add upstream git@github.com:ibm-dojo/grunt-amd-build.git
$ git fetch upstream
```
