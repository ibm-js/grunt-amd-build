// This is foo from myapp/plugin
// This is a second call foo from myapp/plugin
// onLayerEnd
{
	"name": "myapp/include",
	"path": "./myapp/include.js"
}
[
	"normalize: foo",
	"normalize: foo",
	...
	"normalize: foo",
	"normalize: foo",
	"write: myapp/plugin!foo",
	"writeFile: myapp/plugin!foo",
	"addModules: myapp/plugin!foo",
	"onLayerEnd: myapp/include"
]
define('myapp/plugin!foo',{'foo': true});;
define('myapp/plugin!foo1',{'foo' : true});;
